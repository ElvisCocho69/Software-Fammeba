...
import com.api.spring_security.persistence.repository.CategoryRepository;
import com.api.spring_security.service.CategoryService;
...
public class CategoryServiceImpl implements CategoryService {
    ...
    public Category updateOneById(Long categoryId, SaveCategory saveCategory) {
        Category categoryFromDB = categoryRepository.findById(categoryId)
            .orElseThrow(() -> new ObjectNotFoundExeption("Category not found with id: " + categoryId));
